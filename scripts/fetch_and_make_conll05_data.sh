...
export PERL5LIB="$HOME/code/deep_srl/scripts/srlconll-1.1/lib:$PERL5LIB"
export PATH="$HOME/code/deep_srl/scripts/srlconll-1.1/bin/:$PATH"
...
python ~/code/deep_srl/preprocess/process_conll05.py "${CONLL05_PATH}/train-set" "${SRLPATH}/conll05.train.txt" \
  "${SRLPATH}/conll05.propid.train.txt" 4
python ~/code/deep_srl/preprocess/process_conll05.py "${CONLL05_PATH}/dev-set" "${SRLPATH}/conll05.devel.txt" \
  "${SRLPATH}/conll05.propid.devel.txt" 4
python ~/code/deep_srl/preprocess/process_conll05.py "${CONLL05_PATH}/test-wsj" "${SRLPATH}/conll05.test.wsj.txt" \
  "${SRLPATH}/conll05.propid.test.wsj.txt" 1
python ~/code/deep_srl/preprocess/process_conll05.py "${CONLL05_PATH}/test-brown" "${SRLPATH}/conll05.test.brown.txt" \
